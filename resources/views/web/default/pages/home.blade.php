...
<section class="slider-container" style="background-image: url('/assets/default/img/UpDownRemoveAllFinal.png') ">
    @if($heroSection == "1")
    ...
    <div class="container user-select-none">
        ...
        <div class="row slider-content align-items-center hero-section2 flex-column-reverse flex-md-row">
            ...
            <div class="col-12 col-md-5 col-lg-6">
                ...
                <iframe src="/assets/default/img/florid-crypto-wallet-and-online-banking.gif" width="580" height="580" frameBorder="0" class="giphy-embed" allowFullScreen></iframe>
            </div>
        </div>
        @else
